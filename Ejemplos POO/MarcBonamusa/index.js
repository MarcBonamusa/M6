...
function init() {
    console.log("1 Inicializamos el Gestor de Alumnos mediante un JSON.")  
    const gestor = cargarJSON();

    console.log("2. Mostramos lista de alumnos ordenados alfabéticamente")
    console.log(gestor.listarAlumnos())
    ...
    console.log(gestor.buscarAlumno("Beatriz Martínez Sánchez"))
